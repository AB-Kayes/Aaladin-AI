...
import { aaladinServices, aaladinServicesIcons } from "@/constants";
    ...
    <Section id="portfolio">
      <div className="container">
        <Heading
          ...
          text="From discovery to deployment — we build production AI products and integrations."
        />
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {aaladinServicesIcons.map((item, index) => (
                    <li
                      key={index}
